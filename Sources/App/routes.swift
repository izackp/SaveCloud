...
func routes(_ app: Application) throws {
    ...
    */
    ...
    userSessGroup.get("user", "profile", ":profile_id", "games", use: userProfileGamesPage(req:))
    userSessGroup.get("user", "profile", ":profile_id", "games-family", ":family_id", use: userProfileGameSavesPage(req:))
    userSessGroup.get("user", "profile", ":profile_id", "games-family", ":family_id", "saves", "download", use: userProfileGameSavesDownloadPage(req:))
    userSessGroup.get("user", "profile", ":profile_id", "games-family", ":family_id", "saves", "delete", use: deleteUserProfileGameSavesPage(req:))
    userSessGroup.post("user", "profile", ":profile_id", "games-family", ":family_id", "saves", "delete", use: deleteUserProfileGameSaves(req:))
    userSessGroup.get("user", "profile", ":profile_id", "games-family", ":family_id", "saves", ":sequential_id", "delete", use: deleteUserProfileGameSavesPage(req:))
    userSessGroup.post("user", "profile", ":profile_id", "games-family", ":family_id", "saves", ":sequential_id", "delete", use: deleteUserProfileGameSaves(req:))
    userSessGroup.get("user", "profile", ":profile_id", "saves", ":save_id", use: userProfileSaveDownload(req:))
    userSessGroup.get("user", "profile", ":profile_id", "saves", ":save_id", "delete", use: deleteUserProfileSavePage(req:))
    userSessGroup.post("user", "profile", ":profile_id", "saves", ":save_id", "delete", use: deleteUserProfileSave(req:))
    userSessGroup.get("user", "profile", ":profile_id", "saves-sequence", ":sequence_id", use: userProfileSaveSequencePage(req:))
    ...
    userSessGroup.get("users", ":user_id", use: managedUserPageByUserId(req:))
    userSessGroup.get("users", ":user_id", "profiles", ":profile_id", "games", use: managedUserProfileGamesPage(req:))
    userSessGroup.get("users", ":user_id", "profiles", ":profile_id", "games-family", ":family_id", use: managedUserProfileGameSavesPage(req:))
    userSessGroup.get("users", ":user_id", "profiles", ":profile_id", "games-family", ":family_id", "saves", "download", use: managedUserProfileGameSavesDownloadPage(req:))
    userSessGroup.get("users", ":user_id", "profiles", ":profile_id", "games-family", ":family_id", "saves", "delete", use: deleteManagedUserProfileGameSavesPage(req:))
    userSessGroup.post("users", ":user_id", "profiles", ":profile_id", "games-family", ":family_id", "saves", "delete", use: deleteManagedUserProfileGameSaves(req:))
    userSessGroup.get("users", ":user_id", "profiles", ":profile_id", "games-family", ":family_id", "saves", ":sequential_id", "delete", use: deleteManagedUserProfileGameSavesPage(req:))
    userSessGroup.post("users", ":user_id", "profiles", ":profile_id", "games-family", ":family_id", "saves", ":sequential_id", "delete", use: deleteManagedUserProfileGameSaves(req:))
    userSessGroup.get("users", ":user_id", "profiles", ":profile_id", "saves", ":save_id", use: managedUserProfileSaveDownload(req:))
    userSessGroup.get("users", ":user_id", "profiles", ":profile_id", "saves", ":save_id", "delete", use: deleteManagedUserProfileSavePage(req:))
    userSessGroup.post("users", ":user_id", "profiles", ":profile_id", "saves", ":save_id", "delete", use: deleteManagedUserProfileSave(req:))
    userSessGroup.get("users", ":user_id", "profiles", ":profile_id", "saves-sequence", ":sequence_id", use: managedUserProfileSaveSequencePage(req:))
    userSessGroup.get("users", ":user_id", "edit", use: editManagedUserPageByUserId(req:))
    userSessGroup.post("users", ":user_id", "edit", use: updateManagedUser(req:))
