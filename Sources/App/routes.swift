...
func routes(_ app: Application) throws {
    ...
    */
    ...
    userSessGroup.get("profile", ":profile_id", use: userProfileGamesPage(req:))
    userSessGroup.get("profile", ":profile_id", "games", use: userProfileGamesPage(req:))
    userSessGroup.get("profile", ":profile_id", "games-family", ":family_id", use: userProfileGameSavesPage(req:))
    userSessGroup.get("profile", ":profile_id", "games-family", ":family_id", "saves", "download", use: userProfileGameSavesDownloadPage(req:))
    userSessGroup.get("profile", ":profile_id", "games-family", ":family_id", "saves", "delete", use: deleteUserProfileGameSavesPage(req:))
    userSessGroup.post("profile", ":profile_id", "games-family", ":family_id", "saves", "delete", use: deleteUserProfileGameSaves(req:))
    userSessGroup.get("profile", ":profile_id", "games-family", ":family_id", "saves", ":sequential_id", "delete", use: deleteUserProfileGameSavesPage(req:))
    userSessGroup.post("profile", ":profile_id", "games-family", ":family_id", "saves", ":sequential_id", "delete", use: deleteUserProfileGameSaves(req:))
    userSessGroup.get("profile", ":profile_id", "saves", ":save_id", use: userProfileSaveDownload(req:))
    userSessGroup.get("profile", ":profile_id", "saves", ":save_id", "delete", use: deleteUserProfileSavePage(req:))
    userSessGroup.post("profile", ":profile_id", "saves", ":save_id", "delete", use: deleteUserProfileSave(req:))
    userSessGroup.get("profile", ":profile_id", "saves-sequence", ":sequence_id", use: userProfileSaveSequencePage(req:))
